...
export default function Home() {
  ...
  // ---------------------------------------------------------
  // EGYÉB BEÁLLÍTÁSOK (Ne nyúlj hozzá, ha nem muszáj)
  // ---------------------------------------------------------
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900">
      ...
      {(loading || !product) ? (
         <div className="min-h-screen flex items-center justify-center text-gray-500 font-medium">Betöltés...</div>
      ) : (
        <>
          {/* FEJLÉC */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="relative group select-none">
                   ...
                   <div className="aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl bg-gray-100 border-4 border-white relative">
                     ...
                     {/* GOMBOK (Csak akkor, ha több kép van) */}
                    ...
                    {orderStatus === 'success' ? (
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-3">
                           ...
                           <div className="grid grid-cols-2 gap-3">
                               <div><label className="text-[10px] font-bold text-gray-500 uppercase ml-1">Email</label><in