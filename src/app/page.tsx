...
export default function Home() {
  ...
  // 4. FIX KOMMENTEK (Kép kivéve az elsőből!)
  const staticReviews = [
    {
      author: "Varga Niki",
      ...
      date: "2 órája",
      verified: true,
      hasPhoto: false // KÉP KIKAPCSOLVA
    },
    {
      author: "Kovács Petra",
  ...
  // 8. FŐOLDAL MEGJELENÍTÉSE (Egyetlen blokkban a hiba elkerülése végett)
  return (
                    ...
                    <div key={i} className="flex gap-2 items-start animate-fade-in-up">
                      ...
                      <div className="flex-1">
                        <div className="bg-[#f0f2f5] px-3 py-2 rounded-[18px] inline-block relative min-w-[180px]">
                            ...
                            {/* KÉP CSAK AKKOR HA HASPHOTO TRUE */}
                            {review.imageUrl && review.hasPhoto && (
