...
// Külön komponensbe tesszük a logikát, hogy be tudjuk csomagolni
...
// A Fő komponens, ami becsomagolja a tartalmát (Ez oldja meg a hibát!)
export default function SuccessPage() {
  return (
    <div className="min-h-screen bg-brand-light flex items-center justify-center p-4 text-center">
      <Suspense fallback={<div className="text-brand-dark font-bold">Feldolgozás...</div>}>
        <SuccessContent />
      </Suspense>
    </div>
  );
